        ...
        <div>
            {opened && (
                <div className="fixed inset-0 z-[999] h-full w-full overflow-y-auto overflow-x-hidden bg-[#343434]/60" onClick={() => closeByBackdrop()}>
                    ...
                    >
                        <div className="inline-block w-full h-full text-left align-middle">
                            <div
                                className={`relative mx-auto max-w-full h-full overflow-hidden rounded bg-white p-8 text-sm text-gray shadow-lg ${
