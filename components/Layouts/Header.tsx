        ...
        <header className={`sticky top-0 z-50 bg-black/10 duration-300 ${props.className}`}>
            <div className="container">
                <div className="flex items-center justify-between py-2 lg:py-0">
                    <Link href="/">
                        <img src="/assets/images/logo.png" alt="legalmed" className="h-12 md:h-16 w-auto" />
                        {/* <img src="/assets/images/logo.png" alt="legalmed" className="dark:hidden h-12 w-full" /> */}
                    </Link>
                        ...
                        <div className={`menus ${showMenu ? 'overflow-y-auto ltr:!right-0 rtl:!left-0' : ''}`}>
                            ...
                            <ul onClick={() => toggleMenu()}>
                                ...
                                <li>
                                    <Link
                                        href="#about-us"
                                        className={router.pathname === '/' || router.pathname === '/' ? 'active' : 'active'}
                                    >
                                        Quiénes somos
                                    </Link>
                                </li>
                                <li>
                                    <Link
                                        href="#services"
                                        className={router.pathname === '#news' || router.pathname === '#news' ? 'active' : 'active'}
                                    >
                                        Servicios
                                    </Link>
                                </li>
                                <li>
                                    <Link href="#team" className={router.pathname === '#team' ? 'active' : 'active'}>
                                        Equipo
                                    </Link>
                                </li>
                                <li>
                                    <Link href="#contact" className={router.pathname === '#about-us' ? 'active' : 'active'}>
                                        Contacto
                                    </Link>
                                </li>
                                {/* <li>
                                    <Link href="/career" className={router.pathname === '/career' ? 'active' : 'active'}>
                                        Career
                                    </Link>
                                </li> */}
